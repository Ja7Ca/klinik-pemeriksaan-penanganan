...
<h1 class="text-center">Laporan Kunjungan Pasien Unit Gawat Darurat</h1>
    ...
    <?php
        ...
        $i =1;
        $data = query("select ugd.*, pendaftaran.*, pasien.*, dokter.nama_dok from ugd  join dokter on ugd.kode_dok=dokter.kode_dok join (pendaftaran join pasien on pendaftaran.no_rm=pasien.no_rm) on pendaftaran.noreg=ugd.noreg");
    ?>
